...
namespace HSLL
{
	...
	public:
		...
		//获取文件属性
		static DWORD GetFileAttribute(LPCSTR FileName);

		//创建文件
		static BOOL CreateDirectoryA(LPCSTR FileName);
	...
	typedef unsigned long long ADDRESS; // 64位
#else

	typedef unsigned long ADDRESS; // 32位
